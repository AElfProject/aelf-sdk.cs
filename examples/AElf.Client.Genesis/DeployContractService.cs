...
public class DeployContractService : IDeployContractService, ITransientDependency
{
    ...
    public DeployContractService(
        ...
        IOptionsSnapshot<AElfContractOptions> contractOption)
    {
    ...
    public async Task<Address?> DeployContractAsync(string contractFileName)
    {
    ...
    private async Task<ContractDeploymentInput> GetContractDeploymentInputAsync(string name)
    {
    ...
    private async Task<bool> ApproveThroughMinersAsync(Hash proposalId)
    {
    ...
    private async Task<bool> CheckProposalAsync(Hash proposalId)
    {
    ...
    private async Task<bool> CheckCodeAsync(byte[] code)
    {
